...
// @TeleOp(name="Auto", group = "shiningdanyang")
...
//     private Servo srvTurret0 = null;
//     private Servo srvShoot = null;
//     private DcMotorEx motorIntake = null;
//     private DcMotorEx motorShoot = null;
//     private DcMotorEx motorShootStraff = null;
...
//         srvShoot = hardwareMap.get(Servo.class, "srvLoad");
//         motorIntake = hardwareMap.get(DcMotorEx.class, "drvintake");
//         motorShoot = hardwareMap.get(DcMotorEx.class, "drvShoot");
//         motorShootStraff = hardwareMap.get(DcMotorEx.class, "drvShootstraff");
...
//         //1
//         while(opModeIsActive() && robot.strafeDistance > -17)
//         {
...
//         //2
//         while(opModeIsActive() && robot.strafeDistance > -38)
//         {
         
//             moveDrivetrain(-1.0, 0.0, 0.0);
//         }
     
//         while(opModeIsActive() && robot.driveDistance < 38)
//         {
//             moveDrivetrain(0.0, 0.6, 0.0);
//         }
     
//         while(opModeIsActive() && robot.driveDistance > 10)
//         {
//             moveDrivetrain(-0.8, -1.0, 0.0);
//         }
     
     
//         while(opModeIsActive() && robot.driveDistance < 35)
//         {
//             moveDrivetrain(0.0, 0.6, 0.0);
//         }
