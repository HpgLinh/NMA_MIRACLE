...
@Autonomous(name = "Blue up 15", group = "Drive")
public class BLUE_UP_15 extends LinearOpMode {
    ...
    public void moveDrvTrain(double x, double y, double z) {
        ...
        turret.setPosition(Math.toDegrees(angle_unit) - 1);
    ...
    public void step1() {
        ...
        // --- Đi ngang về hàng 2 ---
        while (rawX > -31000 && opModeIsActive()) {
            moveDrvTrain(-1, 0, 0);
        }
    ...
    public void step2() {
        ...
        // --- Tiến vào gạt cần ---
        while (Math.abs(Math.toDegrees(botHeading)) < 28 && opModeIsActive()) {
    ...
    public void step3() {
        ...
        while (rawX > -24500 && opModeIsActive()) {
            moveDrvTrain(-1, 0.5, 0);
        }
        while (rawY < 4200 && opModeIsActive()) {
    ...
    public void step4() {
        ...
        while (rawX > -47500 && opModeIsActive()) {
            moveDrvTrain(-1, 0, 0);
        }

        while (rawY < 8000 && opModeIsActive()) {
            moveDrvTrain(0, 0.8, 0);
        }
