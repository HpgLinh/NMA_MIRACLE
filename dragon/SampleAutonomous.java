...
public class SampleAutonomous extends LinearOpMode
{
    ...
    @Override public void runOpMode()
    {
        ...
        while (opModeIsActive())
        {
            ...
            // robot.drive(  84, 0.60, 0.25, 5);
            // robot.turnTo(90, 0.45, 0.5, 5);
            // robot.drive(  72, 0.60, 0.25, 5);
            // robot.turnTo(180, 0.45, 0.5, 5);
            // robot.drive(  84, 0.60, 0.25, 5);
            // robot.turnTo(270, 0.45, 0.5, 5);
            // robot.drive(  72, 0.60, 0.25, 5);
            // robot.turnTo(0, 0.45, 0.5, 5);

            sleep(500);

            // Drive the path again without turning.
            robot.drive(  84, 1, 0.5, 3);
            robot.strafe( 72, 1, 0.5, 3);
            robot.drive( -84, 1, 0.5, 3);
            robot.strafe(-72, 1, 0.5, 3);
        }
    }
