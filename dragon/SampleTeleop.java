...
@TeleOp(name="Sample Teleop", group = "shiningdanyang")
public class SampleTeleop extends LinearOpMode
{
    ...
    private Servo srvTurret0;     //  control the right back drive wheel
    ...
    @Override public void runOpMode()
    {
        ...
        while (opModeIsActive())
        {
            ...
            {
                srvTurret0.setPosition(0.7);
            }
            else if(!gamepad1.a && gamepad1.b)
            {
                srvTurret0.setPosition(0.3);
            }
            else
            {
                srvTurret0.setPosition(0.5);
            }
            robot.readSensors();
