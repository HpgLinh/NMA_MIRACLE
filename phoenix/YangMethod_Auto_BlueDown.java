...
@TeleOp(name = "Dương's Method Auto Blue Down", group = "Drive")
public class YangMethod_Auto_BlueDown extends LinearOpMode {
    ...
    void active_shoot(double ovalPos, int shootSpeed) {
        ...
        while (waitTimer.seconds() <= 1.6 && opModeIsActive()) {
            moveDrvTrain(0, 0, 0);
        }
    ...
    public void moveDrvTrain(double x, double y, double z) {
        ...
        // --- ODOMETRY & TELEMETRY ---
        rawY = frontLeftMotor.getCurrentPosition() - offsetY;
        rawX = -backRightMotor.getCurrentPosition() - offsetX;
    ...
    public void step0() {
        ...
        while (rawX < 45000 && opModeIsActive()) {
            moveDrvTrain(1, 0, 0);
        }

        active_shoot(0.06, 1650);
        offsetX = rawX+9800;    //càng nhỏ càng lệch về phía trái robot (xa goal)
        offsetY = rawY+9000;
    }
    ...
    public void step1() {
        ...
        // --- Đi ngang về hàng 2 ---
        while (rawX > -28500 && opModeIsActive()) {
            moveDrvTrain(-1, 0, 0);
        }
        ...
        active_shoot(0.06, 1850);
    }

    public void step2() {
        // --- Giai đoạn 2: Di chuyển tới hàng 2 lần nữa và intake ---
        // --- Đi ngang về hàng 2 ---
        while (rawX > -31500 && opModeIsActive()) {
            moveDrvTrain(-1, 0, 0);
        }
        ...
        time1.reset();
        while (time1.seconds() <= 1.5 && opModeIsActive()) {
            moveDrvTrain(0, 0, 0);
        }
    ...
    public void step4() {
        ...
        while (rawX > -46500 && opModeIsActive()) {
            moveDrvTrain(-1, 0, 0);
        }
    ...
    public void step5() {
        ...
        time0.reset();
        while (time0.seconds() <= 0.85 && opModeIsActive()) {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        twoWheelLocalizer = new TwoWheelLocalizer(hardwareMap, twoWheelConstants, new Pose(50, 9, Math.toRadians(180)));
