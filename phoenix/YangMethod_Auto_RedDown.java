...
@TeleOp(name = "Dương's Method Auto Red Down", group = "Drive")
public class YangMethod_Auto_RedDown extends LinearOpMode {
    ...
    public void step2() {
        ...
        time0.reset();
        while (time0.seconds() < 1.7 && opModeIsActive()) {
            moveDrvTrain(0, 0, 0);
        }
        ...
        while (rawX < -19000 && opModeIsActive()) {
            moveDrvTrain(-1, 0, 0);
        }
    ...
    public void step3() {
        ...
        while (rawX > -22000 && opModeIsActive()) {
            moveDrvTrain(1, 0, 0);
        }
        while (rawY < 6000 && opModeIsActive()) {
            moveDrvTrain(0, 0.7, 0);
        }
    ...
    public void step5() {
        ElapsedTime time0 = new ElapsedTime();
        time0.reset();
        while(time0.seconds() <= 0.8 && opModeIsActive()) moveDrvTrain(0.4, 0.4, 0);
    }
    // =========================================================================
    // MAIN OP MODE
    // =========================================================================
    ...
    public void runOpMode() throws InterruptedException {
        ...
        twoWheelLocalizer = new TwoWheelLocalizer(hardwareMap, twoWheelConstants, new Pose(92, 8, Math.toRadians(0)));
