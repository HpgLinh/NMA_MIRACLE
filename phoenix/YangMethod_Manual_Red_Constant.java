...
@TeleOp(name = "HPL MANUAL RED", group = "Drive")
public class YangMethod_Manual_Red_Constant extends LinearOpMode {
    ...
    double turret_offset = 0, angle_unit;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if(head_lock) {
                angle_unit = Math.atan2(138-pose.getY(),135-pose.getX()) - pose.getHeading();
           ...
           // -----------------------------
            ...
            telemetry.addData("head_lock", head_lock ? "On" : "Off");
