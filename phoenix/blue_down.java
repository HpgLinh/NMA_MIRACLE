...
public class blue_down extends LinearOpMode {
    ...
    public void moveDrvTrain(double x, double y, double z) {
        ...
        turret.setPosition(Math.toDegrees(angle_unit) - 3);
    ...
    public void step2() {
        ...
        // --- Đi ngang về hàng 2 ---
        while (rawX > -34550 && opModeIsActive()) {
            moveDrvTrain(-1, 0, 0);
        }

        // --- Gạt cần ---
        while (Math.abs(Math.toDegrees(botHeading)) < 25 && opModeIsActive()) {
        ...
        while (time1.seconds() < 1 && opModeIsActive()) {
            moveDrvTrain(0, 0, 0);
        }
        ...
        while (rawY < 9100 && opModeIsActive()) {
            moveDrvTrain(0, 0.5, 0);
        }
        ElapsedTime time2 = new ElapsedTime();
        while (time2.seconds() < 0.5 && opModeIsActive()) {
            moveDrvTrain(0, 0, 0);
        }
    ...
    public void step4() {
        ...
        while (rawX > -49500 && opModeIsActive()) {
            moveDrvTrain(-1, 0, 0);
        }
