package org.firstinspires.ftc.teamcode.phoenix.geometry;
...
public final class Pose implements FuturePose {
    ...
    public Pose(double x, double y, double heading) {
        this(x, y, heading, DCoordinates.INSTANCE);
    }
     ...
     */
    public VectorD getAsVector() {
        VectorD vector = new VectorD();
     ...
     */
    public VectorD getHeadingAsUnitVector() {
        return new VectorD(1, heading);
    }
     ...
     */
    public Pose mirror() {
        Pose k = getAsCoordinateSystem(DCoordinates.INSTANCE);
        return new Pose(144 - k.getX(), k.getY(), MathFunctions.normalizeAngle(Math.PI - k.getHeading()), DCoordinates.INSTANCE);
    }
