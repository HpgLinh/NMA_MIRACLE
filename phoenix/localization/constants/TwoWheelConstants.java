package org.firstinspires.ftc.teamcode.phoenix.localization.constants;


import org.firstinspires.ftc.teamcode.phoenix.localization.CustomIMU;
import org.firstinspires.ftc.teamcode.phoenix.localization.Encoder;
import org.firstinspires.ftc.teamcode.phoenix.localization.RevHubIMU;
...
public class TwoWheelConstants {
    ...
    public RevHubOrientationOnRobot IMU_Orientation = new RevHubOrientationOnRobot(RevHubOrientationOnRobot.LogoFacingDirection.RIGHT, RevHubOrientationOnRobot.UsbFacingDirection.UP);

    /** The direction of the forward encoder
     * Default Value: Encoder.REVERSE */
    public double forwardEncoderDirection = Encoder.FORWARD;

    /** The direction of the strafe encoder
     * Default Value: Encoder.FORWARD */
    public double strafeEncoderDirection = Encoder.REVERSE;
    ...
    public void defaults() {
        forwardTicksToInches = 0.0019977650;
        strafeTicksToInches = -0.0019586780;
        forwardPodY = 5.1181102362;
        strafePodX = -4.13385826;
