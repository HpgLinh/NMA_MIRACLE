...
@TeleOp(name = "RED_CONSTANT_COPY", group = "Drive")
public class RED_CONSTANT_COPY extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if(head_lock) {
                double angle_unit = Math.atan2(138-pose.getY(),135-pose.getX()) - pose.getHeading();
                ...
                {
                    turret.setPosition(-115);//heading quay ngược về sau (để intake phía sau)
            ...
            else if (stateIntake == 1) intakeDrive.setVelocity(loadOpen ? 2400 : 4000);
